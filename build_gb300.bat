@echo off
REM ========================================
REM  FrogUI v79 Build Script for GB300
REM ========================================
REM
...
wsl bash -c "cd '%WSL_PATH%' && make clean CORE=cores/menu FROGGY_TYPE=GB300V2 && make CORE=cores/menu FROGGY_TYPE=GB300V2"
